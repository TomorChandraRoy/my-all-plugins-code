                    ...
                    <SwiperSlide key={index} className='slide-image'
                        ...
                        <div className='slider-content'>
                            ...
                            {isEditor ?
                                ...
                                }} value={item.title || "Heading..."} onChange={(value) => updateItem(index, "title", value)} placeholder=' Slider Title' /> 
                                : <div className={`h3 animate-slide ${selectedAnimation}`} style={{
                                    animationDelay: `${animationDelay}s`,
                                    animationDuration: `${animationDuration}s`
                                }}   >{item.title}</div>
                            }
                            ...
                            {isEditor ?
                                ...
                                }} value={item.description || "Description.."} onChange={(value) => updateItem(index, "description", value)} placeholder='Slider description' />
                                 : <p className={`dec animate-slide ${decAnimation}`} style={{
                                    animationDelay: `${decAnimationDelay}s`,
                                    animationDuration: `${decAnimationDuration}s`
                                }}>{item.description}</p>
                            }

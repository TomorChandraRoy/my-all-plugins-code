    ...
    dangerouslySetInnerHTML: {
      __html: `
		...
		${ctaSection} {
			...
			border: ${style?.ctaStyle?.borderWidth} solid;
            border-image: linear-gradient(90deg,transparent,${style?.ctaStyle?.borderColor},transparent)1;
		}
		...
		${ctaButtonIcon}{
		    font-size:${style?.ctaStyle?.button?.width};
		}
...
const CallToActionsOne = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    ...
    className: "cta-button-text"
  }, cta?.buttonName), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-button-icon",
    dangerouslySetInnerHTML: {
      __html: cta?.icon
    }
...
const CallToActionsThree = () => {
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, "CallToActionsThree");
};
...
const CallToActionsTwo = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "cta-button-icon cta-button-icon-two",
    dangerouslySetInnerHTML: {
      __html: cta?.icon
    }
  }))) :

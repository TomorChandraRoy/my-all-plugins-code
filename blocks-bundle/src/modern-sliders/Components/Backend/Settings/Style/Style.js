...
import {
  ...
  RangeControl,__experimentalUnitControl as UnitControl,
...
const Style = ({ attributes, setAttributes }) => {
  ...
  const { color, radiusValues, marginValues, typography, headeingColor, headeingMarginValues, animationDuration, animationDelay, selectedAnimation, decColor, decMarginValues, decTypography, decAnimation, decAnimationDelay, decAnimationDuration, colors, buttonHoverColor, buttonTypography, buttonAnimation, buttonAnimationDelay, buttonAnimationDuration, buttonPaddingValues, buttonBorder, buttonRadiusValues, arrayStyle, arrayHeight, arrayWidth, arrayBg,} = attributes;
